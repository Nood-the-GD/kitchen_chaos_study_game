...
#region Photon Controll
    ...
    [PunRPC]
    public void RpcSpawnKitchenObject(string objectType, int photonId, int viewId)
    {
        var kitchenObjectParent = PhotonNetwork.GetPhotonView(photonId).GetComponent<IKitchenObjectParent>();
