...
public class TutorialNavigate : Singleton<TutorialNavigate>
{
    ...
    protected override void Awake()
    {
        ...
        _navigationArrow.transform.DOLocalRotate(new Vector3(0, 360, 0), 2f, RotateMode.FastBeyond360)
    ...
    public void ShowNavigationArrow(Transform target)
    {
        ...
        _navigationArrow.transform.DOMove(position + Vector3.up * 0.3f, 0.5f)
            .SetLoops(-1, LoopType.Yoyo)
            .SetEase(Ease.InOutSine);
